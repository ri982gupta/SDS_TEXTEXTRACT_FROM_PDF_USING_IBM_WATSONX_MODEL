#------------------------------------------ FIND EINECS NUMBER OF CHEMICAL NAME-----------------------------------------------
...
def extract_details_with_llm(text_chunks, chemical_name, llama_model):
    ...
    for chunk in text_chunks:
        prompt = f"Extract the EINECS Number for the chemical name '{chemical_name}' from the following text:\n{chunk}"
...
#         "EINECS_Number": "\n\nThe EINECS number for the chemical name 'Dimethyl glutarate' is 111-42-2."
#     }
# }