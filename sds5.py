#------------------------------------------ FIND RTECS NUMBER OF CHEMICAL NAME-----------------------------------------------
...
def extract_details_with_llm(text_chunks, chemical_name, llama_model):
    ...
    for chunk in text_chunks:
        prompt = f"Extract the RTECS Number for the chemical name '{chemical_name}' from the following text:\n{chunk}"
...
#         "RTECS_Number": "\n\nThe RTECS Number for the chemical name 'Dimethyl glutarate' is:\n\n1119-40-0"
#     }
# }